...
// TODO: Violating Dependency Inversion Principle
// This violates the Dependency Inversion Principle, as the high-level module (OrderService) depends on
// a low-level module (database access) directly.
// We'll see how to fix it by introducing an abstraction layer.
class OrderService {
    fun processOrder(shoppingCart: ShoppingCart) {
        // Direct database access logic for processing the order
        println("Processing order...")
        val db = DatabaseService()
        db.createOrder(shoppingCart)
        // Additional logic...
    }
}
...
class DatabaseService {
    fun createOrder(shoppingCart: ShoppingCart) {
        // Simulated database access logic
...
fun main() {
    ...
    val orderProcessor = OrderService()
